-- Safe Email Setup Migration for Production
-- This migration ONLY ADDS new email features without touching existing data

-- Create EmailType enum only if it doesn't exist
DO $$ BEGIN
...
-- Create global_email_templates table only if it doesn't exist
...
-- Create cohort_email_configs table only if it doesn't exist
CREATE TABLE IF NOT EXISTS "cohort_email_configs" (
  "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "global_email_templates_email_type_idx" ON "global_email_templates"("email_type");
CREATE INDEX IF NOT EXISTS "cohort_email_configs_cohort_id_idx" ON "cohort_email_configs"("cohort_id");
CREATE INDEX IF NOT EXISTS "cohort_email_configs_email_type_idx" ON "cohort_email_configs"("email_type");
